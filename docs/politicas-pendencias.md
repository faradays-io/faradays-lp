...
| --- | ------------------------------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2.1 | Subprocessadores §1, Aviso §12 | Vultr, datacenters em São Paulo e nos EUA; região por contrato       | **Confirmado em 09/09**: há VMs em SP e nos EUA. Falta registrar em qual região está cada Cliente (Monfiza prod: ?) e refletir no contrato de cada um                                                  |
| 2.2 | Subprocessadores §4            | Site na Vercel; e-mail corporativo no Microsoft 365 / Outlook        | **Confirmado em 09/09** e preenchido na tabela                                                                                                                                                         |
