...
/** Disparado quando a cortina termina de revelar a página. */
export const PAGE_TRANSITION_COMPLETE = 'pagetransition:complete'
...
/**
 * Transição de página: cortina preta com um loader (referências:
 * docs/image copy 8.png e 9.png) — uma faixa em gradiente que viaja da
 * esquerda para a direita acompanhando o progresso, pequena no início,
 * esticada no meio e encolhendo no fim, com o percentual ancorado na ponta
 * por uma linha tracejada e um marcador azul. Ao completar, a cortina sai
 * em colunas que caem em cascata para baixo, e o evento
 * PAGE_TRANSITION_COMPLETE avisa quem quiser encadear animações. Com
...
export function PageTransition() {
	...
	useEffect(() => {
		...
		const finish = () => {
			...
			window.dispatchEvent(new CustomEvent(PAGE_TRANSITION_COMPLETE))
		}
