...
|---|---|---|---|---|
| [ ] | 0:11 | modal de disparo | Um BID para todos os exportadores mapeados. | Só quem exporta o produto recebe. |
| [ ] | 0:12 | envelopes voando | E-mail e WhatsApp, num clique. | Quatro exportadores, um disparo. |
| [ ] | 0:14 | e-mail do exportador recebe o BID | O exportador recebe o BID na caixa dele — e responde ali mesmo. | Sem portal, sem formulário: ele responde o e-mail. |
| [ ] | 0:17 | resposta volta ao sistema | A resposta volta sozinha para o comparativo. | A IA lê o e-mail e preenche o comparativo. |
| [ ] | 0:19 | comparativo em zoom | Respostas lidas pela IA, comparadas na mesma base FOB. | /KG e /MT nunca se misturam. |
| [ ] | 0:22 | sugestão da IA | A IA aponta a melhor oferta. Você decide. | Sugestão da IA; a escolha é sua. |
| [ ] | 0:25 | fechar cotação | Fechou. As contra-ofertas saem sozinhas. | Cotação fechada, contra-ofertas enviadas. |
| [ ] | 0:30 | painel do SharePoint entra | Arraste do SharePoint. O sistema lê tipo, produto e validade. | Seus certificados, direto do drive. |
| [ ] | 0:34 | zoom nos status | Validade lida pela IA — sem digitar nada. | Sem data? A IA acha no PDF. |
| [ ] | 0:39 | aba Pastas | As pastas do drive, espelhadas no sistema. | A mesma árvore do SharePoint, com status. |
| [ ] | 0:44 | arquivo enviado no chat | O representante pede; você manda do SharePoint. | Documento no WhatsApp em um arraste. |
| [ ] | 0:49 | IA responde no chat | A IA responde no WhatsApp e emite a cotação. | O representante pergunta, a IA cota. |
...
|---|---|---|---|---|---|---|
| leg.1 | manter | 0:42 (1ª mensagem) | WhatsApp do representante | O representante pergunta pelo WhatsApp, como sempre. | | Ele pergunta onde já pergunta: no WhatsApp. |
| leg.2 | manter | 0:44 (COA chega) | Agente IA · resposta automática | A IA responde na hora — ninguém do seu time precisou digitar. | | Resposta em segundos, sem ninguém do seu lado. |
| leg.3 | manter | 0:47 (pergunta da marca) | Agente IA · resposta automática | Tira a dúvida da marca… | | Confirma a marca… |
| leg.4 | manter | 0:50 (cotação) | Agente IA · cotação emitida | …e emite a cotação, com ICMS e câmbio do dia. | | …e cota na hora, com ICMS e câmbio do dia. |
| leg.5 | manter | 0:52 (sistema entra) | Sistema Faradays | E toda a conversa fica registrada no sistema. | | Tudo registrado no sistema, para a equipe acompanhar. |
